...
this is where we will talk about RSA and its algorithm
I have written an implementation of RSA key generation in rust with sam demorest so I can
cover this section i bet

\section{ElGamal Asymmetric Cryptography}
This seems like another standard public private key crypto algorithm
